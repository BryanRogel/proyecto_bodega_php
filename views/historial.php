...
<title>Devoluciones</title>
        ...
        <script type="text/javascript" src="../resources/js/historial.js"></script>
            ...
            <tr> 
               <td><font color="#FFFFFF" face="arial, verdana, helvetica">
                ...
                <div class="col-md-9" style="margin-top: 30px;">
                    <p class="robo" style="font-weight: 300; margin-bottom: 0px; font-size: 30px;">Historial</p>
                    <p class="robo" style="font-weight: 300; font-size: 14px; height: 40px;">Historial  de devoluciones</p>
                </div>
                <div class="col-md-3" style="margin-top: 30px;">
                 ...
                 <div class="col-md-12" style="margin-top: 10px;">
                    <table id="listadoHistorial" class="mdl-data-table" cellspacing="1" width="100%">
                        <thead>
                              <th>ID Prestamo</th>
                                ...
                                foreach ($data as  $value) {
                                    ...
                                    echo "<tr>
                                            ...
                                            <td>
                                                ...
                                                <input type='button' class='btn-danger btn-sm prestamo' id='".$value['idPrestamo']."' value='Eliminar'>
                                            </td>
                                          </tr>";
                                }
                            }
