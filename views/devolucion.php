...
<?php  require_once 'head.php'; ?>
 <title>Devoluciones</title>
		...
		<script type="text/javascript" src="../resources/js/devolucion.js"></script>
        ...
        <div class="skin-part">
            <div id="tree-wrap">
                <div class="side-bar">
                        ...
                        <li>
                            <a class="tooltip-tip " href="dashboard.php" title="Dashboard">
            ...
            <tr> 
               <td><font color="#FFFFFF" face="arial, verdana, helvetica">
    			...
    			<div class="col-md-9" style="margin-top: 30px;">
		            <p class="robo" style="font-weight: 300; margin-bottom: 0px; font-size: 30px;">Devoluciones</p>
		            <p class="robo" style="font-weight: 300; font-size: 14px; height: 40px;">Gesti&oacute;n  de devoluciones</p>
        		</div>
				<div class="col-md-3" style="margin-top: 30px;">
				 ...
				 <div class="col-md-12" style="margin-top: 10px;">
					<table id="listadoDevoluciones" class="mdl-data-table" cellspacing="1" width="100%">
				 		<thead>
              			<th>ID Prestamo</th>
                      ...
                      <td>".$value['estadoPrestamo']."</td>
			 								<td>
			 									...
			 									<input type='button' class='btn-danger btn-sm devolverPrestamo' id='".$value['idPrestamo']."' value='Devolver'>
			 								</td>
			 						      </tr>";
			 					}
			 				}
 ...
 <div class="modal fade modal" id="modalDevolverPrestamo" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <input type="hidden" name="idPrestamo" id="idDevolverPrestamo">                 
               </form>

                    </div>
                    <div>
                    <button class="btn btn-primary  btn-sm " id="btnDevolverPrestamo" >Devolver</button>
                  </div>
