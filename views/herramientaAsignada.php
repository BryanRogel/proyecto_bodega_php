...
<?php  require_once 'head.php'; ?>
  <title>Asignacion de herramientas a empleados</title>
            ...
            <tr> 
               <td><font color="#FFFFFF" face="arial, verdana, helvetica">
                    <div class="page-header">
                        <h1>Asignacion de herramientas a empleados</h1>
                    </div>
                    <div class="row">
                        <div class="col-md-4">  
                            <div>Empleado:
                    ...
                    <div class="row">
                        <div class="col-md-12 text-right">
                            <button type="button" class="btn btn-sm btn-default guardar-herramientaAsignada" id="<?php echo $detalle['id'];?>">Guardar</button>
                        </div>
                    </div>
                </font></td> 
            </tr> 
